...
tts <- as.numeric((Jan %>% group_by(Variables) %>% summarise(tt = max(Totals, na.rm = T))) %>% summarise(tt=sum(tt)))
...
hc <- hchart(Feb, type = "line", hcaes(x = Dates, y = Totals, group = Variables)) %>% 
  ...
  hc_subtitle(text = paste(max(Feb$Totals, na.rm = T),"Cases", sep = " ")) %>% 
  hc_add_theme(hc_theme_monokai())
...
tts <- as.numeric((Feb %>% group_by(Variables) %>% summarise(tt = max(Totals, na.rm = T))) %>% summarise(tt=sum(tt)))
...
hc <- hchart(March, type = "line", hcaes(x = Dates, y = Totals, group = Variables)) %>% 
  ...
  hc_subtitle(text = paste(max(March$Totals, na.rm = T),"Cases", sep = " ")) %>% 
  hc_add_theme(hc_theme_monokai())
...
tts <- as.numeric((March %>% group_by(Variables) %>% summarise(tt = max(Totals, na.rm = T))) %>% summarise(tt=sum(tt)))
...
hc <- hchart(April, type = "line", hcaes(x = Dates, y = Totals, group = Variables)) %>% 
  ...
  hc_subtitle(text = paste(max(April$Totals, na.rm = T),"Cases", sep = " ")) %>% 
  hc_add_theme(hc_theme_monokai())
...
tts <- as.numeric((April %>% group_by(Variables) %>% summarise(tt = max(Totals, na.rm = T))) %>% summarise(tt=sum(tt)))
